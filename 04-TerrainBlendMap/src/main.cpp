...
Terrain terrain(-1, -1, 200, 8, "../Textures/Map4.png");
...
glm::mat4 modelMatrixOcto = glm::mat4(1.0f);

float rotDartHead = 0.0, rotDartLeftArm = 0.0, rotDartLeftHand = 0.0, rotDartRightArm = 0.0, rotDartRightHand = 0.0, rotDartLeftLeg = 0.0, rotDartRightLeg = 0.0;
int modelSelected = 0;
bool enableCountSelected = true;
int animationIndexOcto = 0;
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	//Octo Callie
	OctoCallie.loadModel("../models/OctoCallie/Octo_Callie5.fbx");
	OctoCallie.setShader(&shaderMulLighting);
	...
	// Definiendo la textura a utilizar
	Texture textureTerrainBackground("../Textures/grassFlowers.png");
	// Carga el mapa de bits (FIBITMAP es el tipo de dato de la libreria)
	...
	// Definiendo la textura a utilizar
	Texture textureTerrainR("../Textures/Text1.png");
	// Carga el mapa de bits (FIBITMAP es el tipo de dato de la libreria)
	...
	// Definiendo la textura a utilizar
	Texture textureTerrainG("../Textures/Text2.png");
	// Carga el mapa de bits (FIBITMAP es el tipo de dato de la libreria)
	...
	// Definiendo la textura a utilizar
	Texture textureTerrainB("../Textures/Text3.png");
	// Carga el mapa de bits (FIBITMAP es el tipo de dato de la libreria)
...
bool processInput(bool continueApplication) {
	...
	if (glfwGetKey(window, GLFW_KEY_C) == GLFW_PRESS)
		animationIndexOcto = 0;
	if (glfwGetKey(window, GLFW_KEY_V) == GLFW_PRESS)
		animationIndexOcto = 1;
	if (glfwGetKey(window, GLFW_KEY_B) == GLFW_PRESS)
		animationIndexOcto = 2;
...
void applicationLoop() {
	...
	while (psi) {
		...
		modelMatrixOcto[3][1] = terrain.getHeightTerrain(modelMatrixOcto[3][0], modelMatrixOcto[3][2]);
		glm::mat4 modelMatrixOctoBody = glm::mat4(modelMatrixOcto);
		modelMatrixOctoBody = glm::scale(modelMatrixOctoBody, glm::vec3(0.005, 0.005, 0.005));
		OctoCallie.setAnimationIndex(animationIndexOcto);
		OctoCallie.render(modelMatrixOctoBody);
